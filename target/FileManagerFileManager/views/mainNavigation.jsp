...
<div region="west" style="width: 200px" title="功能菜单" split="true">
    <div class="easyui-accordion" data-options="fit:true,border:false">
        <div title="账户管理" data-options="selected:true,iconCls:'icon-ok'" style="padding: 10px">
        ...
        <div title="本地文件管理" data-options="iconCls:'icon-mini-add'" selected="true" style="padding: 10px">
        ...
        <div title="云端文件管理" data-options="iconCls:'icon-tip'" selected="true" style="padding: 10px">
